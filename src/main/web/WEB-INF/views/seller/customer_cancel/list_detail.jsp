...
<head>
	<title>취소 상세보기</title>
	<meta charset="UTF-8">
	<link rel="stylesheet" href="/resources/css/seller/cancel/view_detail.css">
...
<body>
	<div id="body">
		...
		<div id="content">
			<h2>취소 상세보기</h2>
			<p class="seller_nav_2"><a href="*">판매자 매니저</a> &gt; <a href="*">취소 관리</a> &gt; <a href="*">취소 상세보기</a></p>
