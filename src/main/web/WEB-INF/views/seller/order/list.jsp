...
<head>
	<title>주문확인</title>
	<meta charset="UTF-8">
	<link rel="stylesheet" href="resources/css/seller/order/view.css">
...
<body>
	<div id="body">
		...
		<div id="content">
			<h2>주문 확인</h2>
			<p class="seller_nav_2"><a href="*">판매자 매니저</a> &gt; <a href="*">주문확인</a></p>
			...
			<table class="table table-hover">
				...
				<tbody>
					<tr>
						...
						<td>주문자</td>
						<td>결제금액</td>
						<td><button class="btn_w3 info">주문확인</button></td>
					</tr>
					<tr>
						<td><input type="checkbox" class="form-check-input"></td>
						<td>주문날짜</td>
						...
						<td>주문자</td>
						<td>결제금액</td>
						<td><button class="btn_w3 checked">주문확인 완료</button></td>
					</tr>
					<tr>
						<td><input type="checkbox" class="form-check-input"></td>
						<td>주문날짜</td>
