...
<head>
	<title>상품등록</title>
	<meta charset="UTF-8">
	<link rel="stylesheet" href="resources/css/seller/product/upload.css">
...
<div id="body">
	...
	<div id="content">
		<h2>상품등록</h2>
		<p class="seller_nav_2"><a href="*">판매자 매니저</a> &gt; <a href="*">상품등록</a></p>
		...
		<button type="button" class="btn btn-primary btn-lg btn-block">상품 등록</button>
		<button type="button" class="btn btn-secondary btn-lg btn-block">등록 취소</button>
